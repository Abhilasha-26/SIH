        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden lg:flex items-center space-x-8 text-gray-600 font-medium">
              ...
              <a href="#benefits" className="hover:text-blue-600 transition-colors duration-200">Benefits</a>
              <a href="#stats" className="hover:text-blue-600 transition-colors duration-200">Impact</a>
              <a href="#contact" className="hover:text-blue-600 transition-colors duration-200">Contact</a>
            </nav>
            
            <div className="hidden md:flex items-center space-x-3">
              <button className="px-5 py-2.5 text-gray-700 font-medium hover:text-blue-600 transition-colors duration-200">
                Login
              </button>
              <button className="px-6 py-2.5 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-medium rounded-xl hover:from-blue-700 hover:to-purple-700 transform hover:scale-105 transition-all duration-200 shadow-lg">
                Start Free Trial
              </button>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button className="px-8 py-4 border-2 border-gray-200 text-gray-700 font-semibold rounded-xl hover:border-blue-300 hover:text-blue-600 transition-all duration-200">
                  Explore Features
                </button>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map(({ icon, title, desc, gradient }, idx) => (
              <div 
                key={idx} 
                className="group relative bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-gray-200"
              >
                <div className={`absolute inset-0 bg-gradient-to-r ${gradient} rounded-2xl opacity-0 group-hover:opacity-5 transition-opacity duration-300`}></div>
      ...
      <section id="stats" className="py-20 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-700">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="space-y-3">
              <div className="text-5xl lg:text-6xl font-bold text-white js-counter" data-target="95">0</div>
            ...
            <div className="space-y-3">
              <div className="text-5xl lg:text-6xl font-bold text-white js-counter" data-target="85">0</div>
            ...
            <div className="space-y-3">
              <div className="text-5xl lg:text-6xl font-bold text-white js-counter" data-target="70">0</div>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Join the education revolution. Schedule a personalized demo and see how Smart Student Hub can elevate your institution.
            </p>
          </div>
          
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="px-10 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-purple-700 transform hover:scale-105 transition-all duration-200 shadow-xl">
              Schedule Free Demo
            </button>
            <button className="px-10 py-4 border-2 border-gray-200 text-gray-700 font-semibold rounded-xl hover:border-blue-300 hover:text-blue-600 transition-all duration-200">
              Start Free Trial
            </button>
          </div>
